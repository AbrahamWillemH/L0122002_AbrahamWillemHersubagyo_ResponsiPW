  ...
  <div class="container">
    <div class="flex flex-col justify-center text-center items-center min-h-screen">
      ...
      <div class="flex flex-col justify-center items-center text-center mt-10">
        <form action="<?php echo e(route('login')); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <?php echo csrf_field(); ?>
...
<?php /**PATH D:\CODE\NGODING_NGODING_TIPES\ngoding_ndes\Web\pemweb-smt-4\project-1\resources\views/auth/login.blade.php ENDPATH**/ ?>